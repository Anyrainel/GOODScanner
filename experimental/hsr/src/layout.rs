...
pub const CHARACTER_NAME: NormRect = NormRect::new(0.0656, 0.059, 0.165, 0.0314);
pub const CHARACTER_LEVEL: NormRect = NormRect::new(0.7975, 0.221, 0.055, 0.040);

pub const RELIC_NAME: NormRect = xyxy(0.0, 0.0, 0.8, 0.09);
...
pub const RELIC_EQUIPPED: NormRect = xyxy(0.45, 0.935, 0.67, 0.965);
...
pub const LIGHT_CONE_SUPERIMPOSITION: NormRect = xyxy(0.53, 0.495, 0.6, 0.55);
...
mod tests {
    ...
    fn kelz_xyxy_panel_crops_convert_to_positive_boxes() {
        ...
        assert!((LIGHT_CONE_SUPERIMPOSITION.width - 0.07).abs() < 1e-9);
